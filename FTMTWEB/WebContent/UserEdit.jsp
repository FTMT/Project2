...
<table style="text-align: left; width: 300px; height: 250px;"
border="1" >
<tbody>
<tr>
<td style="vertical-align: top;" READONLY>Username<br>
</td>
<td style="vertical-align: top;"><input name="Username" value=<%=user.getUsername()%> disabled> </td>
</tr>
<tr>
<td style="vertical-align: top;">Password<br>
</td>
<td style="vertical-align: top;"><input type="password" name="Password" placeholder=<%=user.getPassword()%>> </td>
</tr>
<tr>
...
<td style="vertical-align: top;"><input maxlength="1" disabled name="Type" value=<%=user.getType()%>> </td>
</tr>
<tr>
<td style="vertical-align: top;">Status<br>
</td>
<td style="vertical-align: top;"><input READONLY name="Status" value=<%=user.getStatus()%>> </td>
</tr>
<tr>
